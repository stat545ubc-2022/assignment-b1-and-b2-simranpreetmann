...
#' @examples
#' optimal_histogram(cancer_sample$area_mean, "Mean Area of Biopsy Sample")
#' optimal_histogram(cancer_sample$radius_mean, "Mean Radius of Biopsy Sample", fill = "darkgoldenrod4", color = "darkgoldenrod3", alpha = 0.5)
#' @export
